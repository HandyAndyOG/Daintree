...
const Pagination = () => {
  ...
  return (
    <div className='flex flex-row justify-center items-center p-4'>
        ...
        <BsFillArrowLeftCircleFill className='text-[#dfcdc9] text-3xl mr-2 cursor-pointer' onClick={pageBack}/>
        <p className='px-2 shadow-inner rounded-full text-white bg-[#dfcdc9]'>{currentPage}</p>
        <BsFillArrowRightCircleFill className='text-[#dfcdc9] text-3xl ml-2 cursor-pointer'onClick={pageForward}/>
